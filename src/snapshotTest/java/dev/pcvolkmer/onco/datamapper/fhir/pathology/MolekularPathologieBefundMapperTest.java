...
class MolekularPathologieBefundMapperTest extends DnpmToFhirTest {

  @ParameterizedTest
  @ValueSource(strings = {"ihcreports.json"})
  void shouldMapMolekularPathologieBefund(String filename) throws IOException {
    try (var inputStream =
      ...
      verifyAll(List.of(fhir), filename);
    }
  }
}
